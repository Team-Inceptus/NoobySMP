...
public abstract class SMPEntity<T extends LivingEntity> {
	...
	public static final List<Class<? extends SMPEntity<?>>> CLASS_LIST = ImmutableList.<Class<? extends SMPEntity<?>>>builder()
			.add(JebSheep.class)
			.add(BlackstoneSkeleton.class)
			.add(RubySkeleton.class)
			.build();
	
	public static final List<Class<? extends SMPEntity<?>>> TITAN_CLASS_LIST = ImmutableList.<Class<? extends SMPEntity<?>>>builder()
	...
	public boolean equals(Object obj) {
		...
		try {
			return ent.getEntity().getUniqueId().equals(this.getEntity().getUniqueId());
		} catch (Exception e) {
			return false;
		}
	}
