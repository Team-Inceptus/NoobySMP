...
public class EntityManager implements Listener {
	...
	public static List<EntityDropData> getDrops(EntityType type) {
		...
		switch (type) {
			...
			case DROWNED, DOLPHIN, COD, PUFFERFISH, SALMON, TROPICAL_FISH -> {
				data.add(new EntityDropData(SMPMaterial.AQUATIC_CORE));
				break;
			}
			case WITHER_SKELETON, BLAZE, ZOMBIFIED_PIGLIN, PIGLIN, ZOGLIN, HOGLIN, PIGLIN_BRUTE, STRIDER, GHAST -> {
	...
	public record EntityDropData(ItemStack drop, int intScale, int chance) {
