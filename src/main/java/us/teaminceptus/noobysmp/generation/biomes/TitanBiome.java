...
public enum TitanBiome {
	...
	public static String PLAINS_GRASS() { return "91BD59"; }
	public static String DESERT_GRASS() { return "BFB755"; }
	public static String JUNGLE_GRASS() { return "59C93C"; }
	public static String OCEAN_GRASS() { return "8EB971"; }
	...
	TitanBiome(String name, boolean snow, String waterColor, String fogColor, String skyColor, String grassColor, String foliageColor) {
		this.name = name;
		this.frozen = snow;
	...
	public static TitanBiome getReplaceable(Biome b) {
	...
	public static void registerBiomes() throws Exception {
		...
		for (TitanBiome biome : values()) { 
			ResourceKey<net.minecraft.world.level.biome.Biome> key = ResourceKey.create(Registry.BIOME_REGISTRY, new ResourceLocation("noobysmp", biome.name.toLowerCase().replace(' ', '_')));
		...
		plugin.getLogger().info("Registered " + TitanBiome.values().length + " Titan Biomes");
	}
