...
public final class SMPTag<T extends Event> {
	...
	public enum TagTarget {
		...
		TagTarget(List<Material> targets) {
	...
	public static final SMPTag<PlayerTickEvent> SATURATION = new SMPTag<>(tick, "Saturating", AbilityItem.SCROLL_SATURATION, TagTarget.CHESTPLATES, e -> e.getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.SATURATION, 2, 0)));
	...
	public static final SMPTag<PlayerTickEvent> AQUATIC = new SMPTag<>(tick, "Aquatic", AbilityItem.AQUATIC_ENRICHMENT, TagTarget.ARMOR, e -> e.getPlayer().addPotionEffect(new PotionEffect(PotionEffectType.WATER_BREATHING, 2, 1, true)));
	...
	public static <U extends Event> List<SMPTag<U>> getByType(Class<U> type) {
	...
	public static SMPTag<?> getByOrigin(AbilityItem origin) {
